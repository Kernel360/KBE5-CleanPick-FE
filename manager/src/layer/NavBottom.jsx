...
const BottomNav = () => {
  ...
  const navs = [
    { label: "홈", icon: <FaHome size={20} />, href: "/" },
    { label: "요청", icon: <FaSearch size={20} />, href: "/findrequest" },
    { label: "일정", icon: <FaCalendarAlt size={20} />, href: "/schedule" },
    { label: "내 정보", icon: <FaRegUser size={20} />, href: "/mypage" },
  ];
